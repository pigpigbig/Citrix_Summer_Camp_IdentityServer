!(function (e) {
            ...
            return i(this, void 0, void 0, function () {
                ...
                return a(this, function (a) {
                    switch (a.label) {
                        ...
                        case 1:
                            (p = a.sent()) &&
                                (((i = {}).Authorization = "Bearer " + p), (h = i)),
                                (a.label = 2);
                        case 2:
                            return (
                                e.log(
                                    r.a.Trace,
                                    "(" + t + " transport) sending data. " + u(c, f) + "."
                                ),
                                (d = l(c) ? "arraybuffer" : "text"),
                                [4, n.post(o, { content: c, headers: h, responseType: d })]
                            );
                        case 3:
                            return (
                                (g = a.sent()),
            ...
            return (
                (e.prototype.dispose = function () {
                    ...
                    e > -1 && this.subject.observers.splice(e, 1),
                        ...
                        this.subject.cancelCallback().catch(function (e) { });
                }),
                e
            );
        })(),
                                    ...
                                    ? new Promise(function (n, r) {
                                        ...
                                        s &&
                                            ...
                                            (o.onload = function () {
                                                e.abortSignal && (e.abortSignal.onabort = null),
                                                    o.status >= 200 && o.status < 300
                                                        ...
                                                        : r(new i.b(o.statusText, o.status));
                                            }),
                                            (o.onerror = function () {
                                                t.logger.log(
                                                    c.a.Warning,
                                            ...
                                            (o.ontimeout = function () {
                                                t.logger.log(c.a.Warning, "Timeout from HTTP request."),
                                                    r(new i.c());
                                            }),
                                            o.send(e.content || "");
                                    })
                ...
                function t(t) {
                    ...
                    return (
                        "undefined" != typeof XMLHttpRequest
                            ? (n.httpClient = new l(t))
                            : (n.httpClient = new s.a(t)),
                        n
                    );
                }
                return (
            ...
            y = (function () {
                ...
                return (
                    ...
                    (e.prototype.subscribe = function (e) {
                        return this.observers.push(e), new g.d(this, e);
                    }),
                    e
                );
            })(),
            ...
            E = (function () {
                function e(e, t, n, r) {
                    ...
                    (this.nextKeepAlive = 0),
                        g.a.isRequired(e, "connection"),
                        g.a.isRequired(t, "logger"),
                        g.a.isRequired(n, "protocol"),
                        (this.serverTimeoutInMilliseconds = 3e4),
                        (this.keepAliveIntervalInMilliseconds = 15e3),
                        (this.logger = t),
                        (this.protocol = n),
                        (this.connection = e),
                        (this.reconnectPolicy = r),
                        (this.handshakeProtocol = new p.a()),
                        (this.connection.onreceive = function (e) {
                            return i.processIncomingData(e);
                        }),
                        (this.connection.onclose = function (e) {
                            return i.connectionClosed(e);
                        }),
                        (this.callbacks = {}),
                        (this.methods = {}),
                        ...
                        (this.connectionState = d.Disconnected),
                ...
                return (
                    ...
                    Object.defineProperty(e.prototype, "baseUrl", {
                        ...
                        set: function (e) {
                            if (
                                this.connectionState !== d.Disconnected &&
                                this.connectionState !== d.Reconnecting
                            )
                                throw new Error(
                    ...
                    (e.prototype.startWithStateTransitions = function () {
                        return v(this, void 0, void 0, function () {
                            ...
                            return b(this, function (t) {
                                switch (t.label) {
                                    case 0:
                                        if (this.connectionState !== d.Disconnected)
                                            return [
                                                2,
                                                Promise.reject(
                                                    new Error(
                                ...
                                switch (o.label) {
                                    ...
                                    case 2:
                                        return (
                                            ...
                                            this.logger.log(c.a.Debug, "Sending handshake request."),
                                            [
                                                4,
                                                this.sendMessage(
                                                    this.handshakeProtocol.writeHandshakeRequest(t)
                                                )
                                            ]
                                        );
                                    case 3:
                                    ...
                                    case 4:
                                        if ((o.sent(), this.stopDuringStartError))
                    ...
                    (e.prototype.stopInternal = function (e) {
                        return this.connectionState === d.Disconnected
                            ? (this.logger.log(
                                c.a.Debug,
                                ...
                                Promise.resolve())
                            : this.connectionState === d.Disconnecting
                                ? (this.logger.log(
                                    c.a.Debug,
                                    ...
                                    this.stopPromise)
                                : ((this.connectionState = d.Disconnecting),
                                    this.logger.log(c.a.Debug, "Stopping HubConnection."),
                    ...
                    (e.prototype.stream = function (e) {
                        ...
                        var i,
                            ...
                            s = a[0],
                            c = a[1],
                            u = this.createStreamInvocation(e, n, c),
                            l = new y();
                        return (
                            (l.cancelCallback = function () {
                                var e = t.createCancelInvocation(u.invocationId);
                                return (
                                    delete t.callbacks[u.invocationId],
                                    i.then(function () {
                                        return t.sendWithProtocol(e);
                                    })
                                );
                            }),
                            (this.callbacks[u.invocationId] = function (e, t) {
                                t
                                    ? l.error(t)
                                    : e &&
                                    (e.type === o.Completion
                                        ? e.error
                                            ? l.error(new Error(e.error))
                                            : l.complete()
                                        : l.next(e.item));
                            }),
                            (i = this.sendWithProtocol(u).catch(function (e) {
                                l.error(e), delete t.callbacks[u.invocationId];
                            })),
                    ...
                    (e.prototype.invoke = function (e) {
                        ...
                        var i = this.replaceStreamingParams(n),
                            a = i[0],
                            s = i[1],
                            c = this.createInvocation(e, n, !1, s),
                            u = new Promise(function (e, n) {
                                t.callbacks[c.invocationId] = function (t, r) {
                                    r
                                        ? n(r)
                                        : t &&
                                        (t.type === o.Completion
                                ...
                                var r = t.sendWithProtocol(c).catch(function (e) {
                                    n(e), delete t.callbacks[c.invocationId];
                                });
                                t.launchStreams(a, r);
                            });
                        return u;
                        ...
                        if (e) {
                            ...
                            if (n)
                                if (t) {
                                    var r = n.indexOf(t);
                                    -1 !== r &&
                                        (n.splice(r, 1), 0 === n.length && delete this.methods[e]);
                    ...
                    (e.prototype.processIncomingData = function (e) {
                        if (
                            (this.cleanupTimeout(),
                                ...
                                ((e = this.processHandshakeResponse(e)),
                                    (this.receivedHandshakeResponse = !0)),
                                e)
                        )
                            for (
                                var t = 0, n = this.protocol.parseMessages(e, this.logger);
                                t < n.length;
                                t++
                            ) {
                                var r = n[t];
                                switch (r.type) {
                                    ...
                                    case o.Completion:
                                        ...
                                        i &&
                                            (r.type === o.Completion &&
                                                delete this.callbacks[r.invocationId],
                                                i(r));
                                        break;
                                    case o.Ping:
                                        break;
                                    case o.Close:
                                        ...
                                        var a = r.error
                                            ? new Error(
                                                "Server returned an error on close: " + r.error
                                            )
                                            : void 0;
                                        !0 === r.allowReconnect
                                            ? this.connection.stop(a)
                                            : (this.stopPromise = this.stopInternal(a));
                                        break;
                                    default:
                                        this.logger.log(
                                            c.a.Warning,
                                            "Invalid message type: " + r.type + "."
                                        );
                                }
                            }
                        this.resetTimeoutPeriod();
                    ...
                    (e.prototype.processHandshakeResponse = function (e) {
                        ...
                        return (
                            this.logger.log(c.a.Debug, "Server handshake complete."),
                        ...
                        if (
                            !(
                                ...
                                ((this.timeoutHandle = setTimeout(function () {
                                    ...
                                    void 0 !== this.pingServerHandle)
                            )
                        ) {
                            var t = this.nextKeepAlive - new Date().getTime();
                            t < 0 && (t = 0),
                                (this.pingServerHandle = setTimeout(function () {
                                    return v(e, void 0, void 0, function () {
                                        return b(this, function (e) {
                                            switch (e.label) {
                                                case 0:
                                                    if (this.connectionState !== d.Connected)
                                                        return [3, 4];
                                                    e.label = 1;
                                                case 1:
                                                    return (
                    ...
                    (e.prototype.invokeClientMethod = function (e) {
                        ...
                        if (n) {
                            ...
                            if (e.invocationId) {
                                ...
                                this.logger.log(c.a.Error, r),
                                    (this.stopPromise = this.stopInternal(new Error(r)));
                            }
                        } else
                            this.logger.log(
                                c.a.Warning,
                                "No client method with the name '" + e.target + "' found."
                            );
                    }),
                    (e.prototype.connectionClosed = function (e) {
                        this.logger.log(
                            ...
                            this.connectionState === d.Disconnecting
                                ...
                                : this.connectionState === d.Connected && this.reconnectPolicy
                                    ? this.reconnect(e)
                                    : this.connectionState === d.Connected && this.completeClose(e);
                    }),
                                    ...
                                    case 0:
                                        if (
                                            ((t = Date.now()),
                                                ...
                                                null === (o = this.getNextRetryDelay(n++, 0, r)))
                                        )
                                            return (
                                                this.logger.log(
                                                    c.a.Debug,
                                        ...
                                        if (
                                            ...
                                            if (this.connectionState !== d.Reconnecting)
                                                return (
                                                    this.logger.log(
                                                        c.a.Debug,
                                        ...
                                        return (
                                            ...
                                            this.connectionState !== d.Reconnecting
                                                ...
                                                : ((r =
                                                    ...
                                                    (o = this.getNextRetryDelay(n++, Date.now() - t, r)),
                                                    [3, 6])
                                        );
                                    case 6:
                                        return [3, 1];
                                        ...
                                        (o =
                                            e instanceof Error
                                                ...
                                                : e && e.toString
                                                    ...
                                                    : "Unknown error"),
                                            (t = t.then(function () {
                                                return n.sendWithProtocol(
                                                    n.createCompletionMessage(r, o)
                                                );
                                            }));
                                    },
                                    next: function (e) {
                    ...
                    (e.prototype.createCancelInvocation = function (e) {
                        return { invocationId: e, type: o.CancelInvocation };
                    }),
                    (e.prototype.createStreamItemMessage = function (e, t) {
                        return { invocationId: e, item: t, type: o.StreamItem };
                    }),
                    (e.prototype.createCompletionMessage = function (e, t, n) {
                        return t
                            ? { error: t, invocationId: e, type: o.Completion }
                            : { invocationId: e, result: n, type: o.Completion };
                    }),
                    e
                );
            })(),
            S = [0, 2e3, 1e4, 3e4, null],
            _ = (function () {
                function e(e) {
                    this.retryDelays = void 0 !== e ? e.concat([null]) : S;
                }
                return (
                    (e.prototype.nextRetryDelayInMilliseconds = function (e) {
        ...
        var k = (function () {
            ...
            return (
                (e.prototype.abort = function () {
                    this.isAborted ||
                        ((this.isAborted = !0), this.onabort && this.onabort());
                }),
            ...
            T = (function () {
                ...
                return (
                    Object.defineProperty(e.prototype, "pollAborted", {
                        get: function () {
                        ...
                        return C(this, void 0, void 0, function () {
                            ...
                            return I(this, function (s) {
                                switch (s.label) {
                                    case 0:
                                        if (
                                            (g.a.isRequired(e, "url"),
                                                g.a.isRequired(t, "transferFormat"),
                                                g.a.isIn(t, w, "transferFormat"),
                                                (this.url = e),
                                                this.logger.log(
                                                    c.a.Trace,
                                        ...
                                        return (
                                            ...
                                            t === w.Binary && (n.responseType = "arraybuffer"),
                                    ...
                                    case 1:
                                        return (
                                            ...
                                            this.logger.log(
                                                c.a.Trace,
                                                "(LongPolling transport) polling: " + o + "."
                                            ),
                                            [4, this.httpClient.get(o, n)]
                                        );
                                    case 2:
                                        return (
                                            200 !== (a = s.sent()).statusCode
                                                ? (this.logger.log(
                                                    c.a.Error,
                    ...
                    (e.prototype.poll = function (e, t) {
                        return C(this, void 0, void 0, function () {
                            ...
                            return I(this, function (s) {
                                switch (s.label) {
                                    case 0:
                                        s.trys.push([0, , 8, 9]), (s.label = 1);
                                    case 1:
                                        return this.running ? [4, this.getAccessToken()] : [3, 7];
                                    case 2:
                                        (n = s.sent()), this.updateHeaderToken(t, n), (s.label = 3);
                                    case 3:
                                        return (
                                            s.trys.push([3, 5, , 6]),
                                            (r = e + "&_=" + Date.now()),
                                                ...
                                                : 200 !== o.statusCode
                                                    ...
                                                    : o.content
                                                        ? (this.logger.log(
                                                            ...
                                                            Object(g.f)(o.content, this.logMessageContent) +
                                                            "."
                                                        ),
                                ...
                                switch (o.label) {
                                    case 0:
                                        return (
                                            ...
                                            g.a.isRequired(t, "transferFormat"),
                                            g.a.isIn(t, w, "transferFormat"),
                                            this.logger.log(c.a.Trace, "(SSE transport) Connecting."),
                                            (this.url = e),
                                            this.accessTokenFactory
                                                ? [4, this.accessTokenFactory()]
                                                : [3, 2]
                                    ...
                                    case 2:
                                        return [
                                            ...
                                            new Promise(function (n, o) {
                                                ...
                                                if (t === w.Text) {
                                                    var a;
                                                    if (g.c.isBrowser || g.c.isWebWorker)
                                                            ...
                                                            if (r.onreceive)
                                                                try {
                                                                    r.logger.log(
                                                                        ...
                                                                        Object(g.f)(e.data, r.logMessageContent) +
                                                                        "."
                                                                    ),
                                                                        r.onreceive(e.data);
                                                                } catch (e) {
                                    ...
                                    case 2:
                                        return [
                                            ...
                                            new Promise(function (n, o) {
                                                ...
                                                g.c.isNode &&
                                                    a &&
                                                    (i = new r.webSocketConstructor(e, void 0, {
                                                        headers: { Cookie: "" + a }
                                                    })),
                                                    i || (i = new r.webSocketConstructor(e)),
                                                    t === w.Binary && (i.binaryType = "arraybuffer"),
                                                    (i.onopen = function (t) {
                                                        r.logger.log(
                                                            c.a.Information,
                    ...
                    (e.prototype.send = function (e) {
                        return this.webSocket &&
                            ...
                            ? (this.logger.log(
                                ...
                                Object(g.f)(e, this.logMessageContent) +
                                "."
                            ),
        ...
        var N = (function () {
            function e(e, t) {
                void 0 === t && (t = {}),
                    ...
                    g.a.isRequired(e, "url"),
                    (this.logger = Object(g.e)(t.logger)),
                    (this.baseUrl = this.resolveUrl(e)),
                    ((t = t || {}).logMessageContent = t.logMessageContent || !1),
                    g.c.isNode || "undefined" == typeof WebSocket || t.WebSocket
                        ? g.c.isNode && !t.WebSocket && A && (t.WebSocket = A)
                        : (t.WebSocket = WebSocket),
                    g.c.isNode || "undefined" == typeof EventSource || t.EventSource
                        ? g.c.isNode &&
                        !t.EventSource &&
                        void 0 !== B &&
                        (t.EventSource = B)
                        : (t.EventSource = EventSource),
                    (this.httpClient = t.httpClient || new h(this.logger)),
            ...
            return (
                                    ...
                                    return (
                                        ...
                                        "Disconnected" !== this.connectionState
                                            ...
                                            : ((this.connectionState = "Connecting "),
                                                (this.startInternalPromise = this.startInternal(e)),
                ...
                (e.prototype.send = function (e) {
                    return "Connected" !== this.connectionState
                        ...
                        : (this.sendQueue || (this.sendQueue = new F(this.transport)),
                            this.sendQueue.send(e));
                }),
                                    ...
                                    return "Disconnected" === this.connectionState
                                        ...
                                        : "Disconnecting" === this.connectionState
                                            ...
                                            : ((this.connectionState = "Disconnecting"),
                                                (this.stopPromise = new Promise(function (e) {
                        ...
                        return j(this, function (s) {
                            switch (s.label) {
                                ...
                                case 1:
                                    return (
                                        ...
                                        this.options.skipNegotiation
                                            ? this.options.transport !== m.WebSockets
                                                ? [3, 3]
                                                : ((this.transport = this.constructTransport(
                                                    m.WebSockets
                                                )),
                                                    [4, this.startTransport(t, e)])
                                            : [3, 5]
                                    );
                                case 2:
                                    return s.sent(), [3, 4];
                                ...
                                case 9:
                                    ...
                                    return [
                                        4,
                                        this.createTransport(t, this.options.transport, n, e)
                                    ];
                                case 10:
                                    s.sent(), (s.label = 11);
                                case 11:
                                    return (
                                        this.transport instanceof T &&
                    ...
                    return D(this, void 0, void 0, function () {
                        ...
                        return j(this, function (u) {
                            switch (u.label) {
                                ...
                                case 1:
                                    (r = u.sent()) &&
                                        (((t = {}).Authorization = "Bearer " + r), (n = t)),
                                        (u.label = 2);
                                case 2:
                                    (o = this.resolveNegotiateUrl(e)),
                                        this.logger.log(
                                            c.a.Debug,
                                            "Sending negotiation request: " + o + "."
                                        ),
                                        (u.label = 3);
                                case 3:
                                    return (
                                ...
                                case 4:
                                    return 200 !== (i = u.sent()).statusCode
                                        ? [
                                            2,
                                            Promise.reject(
                                                new Error(
                                        ...
                                        : ((!(a = JSON.parse(i.content)).negotiateVersion ||
                                            a.negotiateVersion < 1) &&
                                ...
                                case 5:
                                    return (
                                        ...
                                        this.logger.log(
                                            c.a.Error,
                                            "Failed to complete negotiation with the server: " + s
                                        ),
                                        [2, Promise.reject(s)]
                                    );
                                case 6:
                ...
                (e.prototype.createTransport = function (e, t, n, r) {
                    return D(this, void 0, void 0, function () {
                        var o, i, a, s, u, l, f, h, p, d, g;
                        return j(this, function (y) {
                            switch (y.label) {
                                case 0:
                                    return (
                                        (o = this.createConnectUrl(e, n.connectionToken)),
                                        this.isITransport(t)
                                            ? (this.logger.log(
                                                c.a.Debug,
                                ...
                                case 3:
                                    return u < l.length
                                        ? ((f = l[u]),
                                            (h = this.resolveTransportOrError(f, t, r)) instanceof
                                                Error
                                                ? (i.push(f.transport + " failed: " + h), [3, 12])
                                                : [3, 4])
                                        : [3, 13];
                                case 4:
                                ...
                                case 5:
                                    return (
                                        y.trys.push([5, 7, , 8]),
                                        [4, this.getNegotiationResponse(e)]
                                    );
                                case 6:
                                    return (s = y.sent()), [3, 8];
                                case 7:
                                ...
                                case 8:
                                    (o = this.createConnectUrl(e, s.connectionToken)),
                                        (y.label = 9);
                                case 9:
                                    return (
                                        y.trys.push([9, 11, , 12]), [4, this.startTransport(o, r)]
                                    );
                                case 10:
                                    ...
                                    return (
                                        ...
                                        "Connecting " !== this.connectionState
                                            ? ((g =
                                                ...
                                                this.logger.log(c.a.Debug, g),
                                                [2, Promise.reject(new Error(g))])
                                            : [3, 12]
                                    );
                                case 12:
                                    return u++, [3, 3];
                ...
                (e.prototype.resolveTransportOrError = function (e, t, n) {
                    ...
                    if (
                        ...
                        return (
                            ...
                            new Error("'" + m[r] + "' is disabled by the client.")
                        );
                    if (
                        !(
                            e.transferFormats
                        ...
                        return (
                            ...
                            new Error("'" + m[r] + "' does not support " + w[n] + ".")
                        );
                    if (
                        (r === m.WebSockets && !this.options.WebSocket) ||
                        (r === m.ServerSentEvents && !this.options.EventSource)
                    )
                        return (
                            this.logger.log(
                                c.a.Debug,
                            ...
                            new Error("'" + m[r] + "' is not supported in your environment.")
                        );
                    this.logger.log(c.a.Debug, "Selecting transport '" + m[r] + "'.");
                    try {
                ...
                (e.prototype.resolveUrl = function (e) {
                    if (
                        ...
                        return e;
                    if (!g.c.isBrowser || !window.document)
                ...
                (e.prototype.resolveNegotiateUrl = function (e) {
                    ...
                    return (
                        ...
                        (n += "negotiate"),
                        -1 ===
                        (n += -1 === t ? "" : e.substring(t)).indexOf(
                            "negotiateVersion"
                        ) &&
                        ((n += -1 === t ? "?" : "&"),
                            (n += "negotiateVersion=" + this.negotiateVersion)),
                        n
                    );
                }),
                e
        ...
        var F = (function () {
            function e(e) {
                (this.transport = e),
                    (this.buffer = []),
                    (this.executing = !0),
                    (this.sendBufferedData = new H()),
                    (this.transportResult = new H()),
            ...
            return (
                (e.prototype.send = function (e) {
                    return (
                        this.bufferData(e),
                        this.transportResult || (this.transportResult = new H()),
                ...
                (e.prototype.bufferData = function (e) {
                    if (this.buffer.length && typeof this.buffer[0] != typeof e)
                        throw new Error(
                                    ...
                                    (this.sendBufferedData = new H()),
                                        ...
                                        (n =
                                            "string" == typeof this.buffer[0]
                                                ? this.buffer.join("")
                                                : e.concatBuffers(this.buffer)),
                                        (this.buffer.length = 0),
                                        (o.label = 2);
                                case 2:
                                    return (
                                        o.trys.push([2, 4, , 5]), [4, this.transport.send(n)]
                                    );
                                case 3:
            ...
            z = (function () {
                ...
                return (
                    (e.prototype.parseMessages = function (e, t) {
                        if ("string" != typeof e)
                            throw new Error(
                                "Invalid input for JSON hub protocol. Expected a string."
                            );
                        if (!e) return [];
                        null === t && (t = q.a.instance);
                        for (var n = [], r = 0, i = W.a.parse(e); r < i.length; r++) {
                            var a = i[r],
                                s = JSON.parse(a);
                    ...
                    (e.prototype.writeMessage = function (e) {
                        return W.a.write(JSON.stringify(e));
                    }),
            ...
            J = {
                trace: c.a.Trace,
                debug: c.a.Debug,
                info: c.a.Information,
                information: c.a.Information,
                warn: c.a.Warning,
                warning: c.a.Warning,
                error: c.a.Error,
                critical: c.a.Critical,
                none: c.a.None
            };
        var K = (function () {
            function e() { }
            return (
                (e.prototype.configureLogging = function (e) {
                    if ((g.a.isRequired(e, "logging"), void 0 !== e.log)) this.logger = e;
                    else if ("string" == typeof e) {
                        var t = (function (e) {
                            var t = J[e.toLowerCase()];
                            if (void 0 !== t) return t;
                            throw new Error("Unknown log level: " + e);
                        })(e);
                        this.logger = new g.b(t);
                    } else this.logger = new g.b(e);
                    return this;
                }),
                (e.prototype.withUrl = function (e, t) {
                    return (
                        g.a.isRequired(e, "url"),
                        (this.url = e),
                        (this.httpConnectionOptions = Y(
                            {},
                            this.httpConnectionOptions,
                            "object" == typeof t ? t : { transport: t }
                        )),
                        this
                    );
                }),
                (e.prototype.withHubProtocol = function (e) {
                    return g.a.isRequired(e, "protocol"), (this.protocol = e), this;
                }),
                (e.prototype.withAutomaticReconnect = function (e) {
                    ...
                    return (
                        e
                            ? Array.isArray(e)
                                ? (this.reconnectPolicy = new _(e))
                                : (this.reconnectPolicy = e)
                            : (this.reconnectPolicy = new _()),
                        this
                    );
                }),
                (e.prototype.build = function () {
                    ...
                    var t = new N(this.url, e);
                    return E.create(
                        t,
                        this.logger || q.a.instance,
                        this.protocol || new z(),
        ...
        var r,
            ...
            i = (function (e) {
                function t(t, n) {
                    ...
                    return (
                        ((r = e.call(this, t) || this).statusCode = n), (r.__proto__ = o), r
                    );
                }
                return o(t, e), t;
            })(Error),
            ...
            i = (function () {
                ...
                return (
                    (e.prototype.get = function (e, t) {
                        return this.send(r({}, t, { method: "GET", url: e }));
                    }),
                    (e.prototype.post = function (e, t) {
                        return this.send(r({}, t, { method: "POST", url: e }));
                    }),
                    (e.prototype.delete = function (e, t) {
                        return this.send(r({}, t, { method: "DELETE", url: e }));
                    }),
    ...
    function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }), n(28), n(22);
        var r = n(29),
            o = n(17),
            i = {},
            a = !1;
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), n(21);
        var i,
            a = n(9),
            s = !1,
            c = !1,
        ...
        e.exports = function (e) {
            ...
            return {
                ...
                registerEncoder: function (e, n) {
                    return (
                        o(e, "must have an encode function"),
                        o(n, "must have an encode function"),
                        t.push({ check: e, encode: n }),
                        this
                    );
                },
    ...
    function (e, t, n) {
        ...
        function s(e, t, n) {
            var i = e;
            if (e instanceof Comment && (u(i) && u(i).length > 0))
                throw new Error(
        ...
        !(function (e) {
            ...
            function c(e, t, r, i) {
                ...
                var a = o++,
                    s = new Promise(function (e, t) {
                        n[a] = { resolve: e, reject: t };
                    });
                try {
                    var c = JSON.stringify(i, g);
                    u().beginInvokeDotNetFromJS(a, e, t, r, c);
                } catch (e) {
                    l(a, !1, e);
                }
                return s;
            ...
            (e.attachDispatcher = function (e) {
                ...
                (e.jsCallDispatcher = {
                    ...
                    invokeJSFromDotNet: function (e, t) {
                        ...
                        return null == n ? null : JSON.stringify(n, g);
                    },
                    beginInvokeJSFromDotNet: function (e, t, n) {
                        ...
                        e &&
                            r.then(
                                function (t) {
                                    return u().endInvokeJSFromDotNet(
                                        e,
                                        !0,
                                        JSON.stringify([e, !0, t], g)
                                    );
                                },
                                function (t) {
                                    return u().endInvokeJSFromDotNet(
            ...
            var d = (function () {
                ...
                return (
                    ...
                    (e.prototype.dispose = function () {
                        c(null, "__Dispose", this._id, null).catch(function (e) {
    ...
    function (e, t, n) {
        ...
        o.inherits(a, r),
            ...
            (a.prototype.append = function (e) {
                var t = 0;
                if (i.isBuffer(e)) this._appendBuffer(e);
            ...
            (a.prototype.copy = function (e, t, n, r) {
                ...
                if (0 === n && r == this.length) {
                    if (!s)
                        return 1 === this._bufs.length
                            ? this._bufs[0]
                            : i.concat(this._bufs, this.length);
                ...
                for (
                    s || (e = i.allocUnsafe(u)), a = c[0];
                    a < this._bufs.length;
                    a++
                ) {
                    if (!(l > (o = this._bufs[a].length - h))) {
                        this._bufs[a].copy(e, f, h, h + l), (f += o);
                        break;
                    }
            ...
            (a.prototype.indexOf = function (e, t, n) {
                ...
                for (
                    var r = this._offset(t), o = r[0], s = r[1];
                    o < this._bufs.length;
                    o++
                ) {
                    for (var c = this._bufs[o]; s < c.length;) {
                        if (c.length - s >= e.length) {
                            var u = c.indexOf(e, s);
                            if (-1 !== u) return this._reverseOffset([o, u]);
                            s = c.length - e.length + 1;
                        } else {
                            var l = this._reverseOffset([o, s]);
                            if (this._match(l, e)) return l;
                            s++;
                        }
                    }
                    s = 0;
            ...
            p = (function () {
                ...
                return (
                    ...
                    (e.prototype.updateComponent = function (e, t, n, r) {
                        ...
                        var c = i.getClosestDomElement(o).ownerDocument,
                            u = c && c.activeElement;
                            ...
                            switch (m) {
                                ...
                                case r.EditType.setAttribute:
                                    (w = h.newTreeIndex(b)),
                                        (E = e.referenceFramesEntry(s, w)),
                                        (S = h.siblingIndex(b));
                                    if (!((_ = i.getLogicalChild(n, l + S)) instanceof Element))
                                        throw new Error(
                                ...
                                case r.EditType.removeAttribute:
                                    ...
                                    S = h.siblingIndex(b);
                                    if (
                                        !((_ = i.getLogicalChild(n, l + S)) instanceof HTMLElement)
                                    )
                                        throw new Error(
                                            "Cannot remove attribute from non-element child"
                                        );
                                    var k = h.removedAttributeName(b);
                                    this.tryApplySpecialProperty(e, _, k, null) ||
                                        _.removeAttribute(k);
                                    break;
                    ...
                    (e.prototype.insertElement = function (e, t, n, o, a, s, c) {
                        var u = e.frameReader,
                            ...
                            h = i.toLogicalElement(f);
                        i.insertLogicalChild(f, n, o);
                        for (var p = c + u.subtreeLength(s), d = c + 1; d < p; d++) {
                            var g = e.referenceFramesEntry(a, d);
                            if (u.frameType(g) !== r.FrameType.attribute) {
                                this.insertFrameRange(e, t, h, 0, a, d, p);
                                break;
                            }
                            this.applyAttribute(e, t, f, g);
                        }
                        if (f instanceof HTMLSelectElement && "_blazorSelectValue" in f) {
                            var y = f._blazorSelectValue;
                            (f.value = y), delete f._blazorSelectValue;
                        }
                    }),
                    ...
                    (e.prototype.tryApplyValueProperty = function (e, t, n) {
                        ...
                        switch (t.tagName) {
                            ...
                            case "TEXTAREA":
                                ...
                                return (
                                    (t.value = i),
                                    "SELECT" === t.tagName && (t._blazorSelectValue = i),
                                    !0
                                );
                            case "OPTION":
                                (i = n ? r.attributeValue(n) : null)
            ...
            s = (function () {
                function e(t) {
                    ...
                    (this.eventsCollectionKey = "_blazorEvents_" + n),
                        (this.eventInfoStore = new c(this.onGlobalEvent.bind(this)));
                }
                return (
                    ...
                    (e.prototype.getEventHandlerInfosForElement = function (e, t) {
                        return e.hasOwnProperty(this.eventsCollectionKey)
                            ...
                            : t
                                ? (e[this.eventsCollectionKey] = new u())
                                : null;
                    }),
    ...
    function (e, t, n) {
        (function (e) {
                ...
                if (
                    ((c = Object.getOwnPropertyDescriptor(t, o) || { value: t[o] }).get
                        ...
                        (e.seen.indexOf(c.value) < 0
                            ? (s = g(n) ? l(e, c.value, null) : l(e, c.value, n - 1)).indexOf(
                                "\n"
                            ) > -1 &&
                            (s = i
                                ? s
            ...
            (t.debuglog = function (n) {
                if (
                    (b(i) && (i = e.env.NODE_DEBUG || ""), (n = n.toUpperCase()), !a[n])
                )
    ...
    function (e, t, n) {
        ...
        (function (t, r) {
            ...
            function m(e) {
                if (((i = i || n(18)), !(this instanceof m))) return new m(e);
            ...
            (m.prototype.read = function (e) {
                ...
                if (
                    ...
                    return (
                        ...
                        0 === t.length && t.ended ? O(this) : _(this),
                        null
                    );
                ...
                (m.prototype.pipe = function (e, t) {
                    ...
                    var c =
                        (!t || !1 !== t.end) && e !== r.stdout && e !== r.stderr ? l : m;
                    function u(t, r) {
                        p("onunpipe"),
                            t === n &&
                            r &&
                    ...
                    var f = (function (e) {
                        return function () {
                            ...
                            p("pipeOnDrain", t.awaitDrain),
                                ...
                                0 === t.awaitDrain && s(e, "data") && ((t.flowing = !0), R(e));
                        };
                    })(n);
                    e.on("drain", f);
                    var h = !1;
                    ...
                    if ("data" === e) !1 !== this._readableState.flowing && this.resume();
                        ...
                        r.endEmitted ||
                            ...
                            ((r.readableListening = r.needReadable = !0),
                                (r.emittedReadable = !1),
                                r.reading ? r.length && _(this) : o.nextTick(T, this));
                    }
                    return n;
                }),
                ...
                (m.prototype.resume = function () {
                    ...
                    return (
                        ...
                        (p("resume"),
                            ...
                            (function (e, t) {
                                t.resumeScheduled ||
                                    ((t.resumeScheduled = !0), o.nextTick(x, e, t));
                            })(this, e)),
                        this
                    );
                }),
    ...
    function (e, t, n) {
        ...
        (function (t, r, o) {
            ...
            function v(e, t) {
                ...
                (this.highWaterMark = o || 0 === o ? o : r && (u || 0 === u) ? u : l),
                    (this.highWaterMark = Math.floor(this.highWaterMark)),
                    (this.finalCalled = !1),
                    (this.needDrain = !1),
                    (this.ending = !1),
            ...
            function b(e) {
                if (((s = s || n(18)), !(d.call(b, this) || this instanceof s)))
                    return new b(e);
                ...
                if (e._writev && n && n.next) {
                    ...
                    for (; n;) {
                        var u = n.chunk,
                            ...
                            f = n.callback;
                        if (
                            (m(e, t, !1, t.objectMode ? 1 : u.length, u, l, f),
                                (n = n.next),
                    ...
                    (!(function (e, t) {
                        t.prefinished ||
                            ...
                            ("function" == typeof e._final
                                ? (t.pendingcb++, (t.finalCalled = !0), i.nextTick(_, e, t))
        ...
        }.call(this, n(14), n(46).setImmediate, n(7)));
    },
    function (e, t, n) {
        (function (e) {
            var r =
    ...
    function (e, t, n) {
        ...
        (function (t, r) {
            ...
            function m(e) {
                if (((i = i || n(19)), !(this instanceof m))) return new m(e);
                (this._readableState = new b(e, this)),
                    (this.readable = !0),
                    e &&
                    ("function" == typeof e.read && (this._read = e.read),
    ...
    function (e, t, n) {
        ...
        (function (t, r, o) {
            ...
            function b(e) {
                if (((s = s || n(19)), !(d.call(b, this) || this instanceof s)))
                    return new b(e);
                (this._writableState = new v(e, this)),
                    (this.writable = !0),
                    e &&
            ...
            var h = (function (t) {
                function n(e) {
                    ...
                    return (
                        (n.logger = e),
                        (n.cookieJar = o.jar()),
                        (n.request = o.defaults({ jar: n.cookieJar })),
                        n
                    );
                }
                return (
                            ...
                            : new Promise(function (r, o) {
                                ...
                                var f = n.request(
                                    t.url,
                                    {
                                        body: u,
                                        encoding:
                                            "arraybuffer" === t.responseType ? null : "utf8",
                                        headers: l(
                                    ...
                                    function (e, c, u) {
                                        if ((t.abortSignal && (t.abortSignal.onabort = null), e))
                                            return (
                                                "ETIMEDOUT" === e.code &&
                                                (n.logger.log(
                                                    s.a.Warning,
                                        ...
                                        c.statusCode >= 200 && c.statusCode < 300
                                            ? r(new a.b(c.statusCode, c.statusMessage || "", u))
                                            : o(new i.b(c.statusMessage || "", c.statusCode || 0));
                                    }
                                );
                                t.abortSignal &&
                    ...
                    (n.prototype.getCookieString = function (e) {
                        return this.cookieJar.getCookieString(e);
                    }),
                    n
                );
            })(a.a);
        ...
        (function (e) {
            ...
            var r = n(12),
                ...
                i = (function () {
                    function t() { }
                    return (
                        (t.prototype.writeHandshakeRequest = function (e) {
                            return r.a.write(JSON.stringify(e));
                        }),
                        (t.prototype.parseHandshakeResponse = function (t) {
                            var n, i;
                            if (Object(o.g)(t) || (void 0 !== e && t instanceof e)) {
                                var a = new Uint8Array(t);
                                if (-1 === (c = a.indexOf(r.a.RecordSeparatorCode)))
                                    throw new Error("Message is incomplete.");
                                var s = c + 1;
                                ...
                                s = c + 1;
                                (n = u.substring(0, s)),
                                    (i = u.length > s ? u.substring(s) : null);
                            }
                            var l = r.a.parse(n),
                                f = JSON.parse(l[0]);
                            if (f.type)
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), n(21), n(27);
        var s = n(2),
            c = n(95),
            u = n(35),
            l = n(38),
        ...
        function E(e) {
            return r(this, void 0, void 0, function () {
                ...
                return o(this, function (g) {
                    switch (g.label) {
                        case 0:
                            if (w) throw new Error("Blazor has already started.");
                            return (
                                (w = !0),
                                (t = y.resolveOptions(e)),
                                (n = new h.ConsoleLogger(t.logLevel)),
                                (window.Blazor.defaultReconnectionHandler = new v.DefaultReconnectionHandler(
                                    n
                                )),
                                ...
                                n.log(
                                    p.LogLevel.Information,
                                    "Starting up blazor server-side application."
                                ),
                                (i = d.discoverComponents(document)),
                                (a = new d.CircuitDescriptor(i)),
                                [4, S(t, n, a)]
                            );
                        case 1:
                            return (s = g.sent()), [4, a.startCircuit(s)];
                        case 2:
                            return g.sent()
                                ? ((c = function (e) {
                                    return r(f, void 0, void 0, function () {
                                        ...
                                        return o(this, function (o) {
                                            switch (o.label) {
                                                ...
                                                case 3:
                                                    return o.sent()
                                                        ? (t.reconnectionHandler.onConnectionUp(),
                                                            [2, !0])
                                                        : (n.log(
                                                            p.LogLevel.Information,
                                    ...
                                    (l = function () {
                                        if (!u) {
                                            ...
                                            e.append("circuitId", t),
                                                (u = navigator.sendBeacon("_blazor/disconnect", e));
                                        }
                                    }),
                                    (window.Blazor.disconnect = l),
                                    window.addEventListener("unload", l, {
                                        capture: !1,
                                        once: !0
                                    }),
                                    (window.Blazor.reconnect = c),
                                    n.log(
                                        p.LogLevel.Information,
                                        "Blazor server-side application started."
                                    ),
                                    [2])
                                : (n.log(p.LogLevel.Error, "Failed to start the circuit."),
                                    [2]);
                    }
                });
            });
        ...
        function S(e, t, n) {
            return r(this, void 0, void 0, function () {
                ...
                return o(this, function (o) {
                    switch (o.label) {
                        case 0:
                            ((r = new c.MessagePackHubProtocol()).name = "blazorpack"),
                                (i = new s.HubConnectionBuilder()
                                    .withUrl("_blazor")
                                    .withHubProtocol(r)),
                                e.configureSignalR(i),
                                (l = i.build()),
                                g.setEventDispatcher(function (e, t) {
                                    return l.send(
                                ...
                                window.Blazor._internal.navigationManager.listenForNavigationEvents(
                                    function (e, t) {
                                        return l.send("OnLocationChanged", e, t);
                                    }
                                ),
                                l.on("JS.AttachComponent", function (e, t) {
                                    return b.attachRootComponentToLogicalElement(
                                        0,
                                        n.resolveElement(t),
                                        e
                                    );
                                ...
                                l.on("JS.EndInvokeDotNet", function (e) {
                                    var t;
                                    return (t =
                                        DotNet.jsCallDispatcher).endInvokeDotNetFromJS.apply(
                                            t,
                                            a(JSON.parse(e))
                                        );
                                }),
                                (h = f.RenderQueue.getOrCreate(t)),
                                l.on("JS.RenderBatch", function (e, n) {
                                    t.log(
                                        p.LogLevel.Debug,
                                        "Received render batch with id " +
                                        e +
                                        " and " +
                                        n.byteLength +
                                        " bytes."
                                    ),
                                        h.processBatch(e, n, l);
                                }),
                                ...
                                l.on("JS.Error", function (e) {
                                    (m = !0), _(l, e, t), u.showErrorNotification();
                                }),
                                ...
                                (o.label = 1);
                        case 1:
                            return o.trys.push([1, 3, , 4]), [4, l.start()];
                        case 2:
                            return o.sent(), [3, 4];
                        case 3:
                            return (d = o.sent()), _(l, d, t), [3, 4];
                        case 4:
                            return (
                                DotNet.attachDispatcher({
                                    ...
                                    endInvokeJSFromDotNet: function (e, t, n) {
                                        l.send("EndInvokeJSFromDotNet", e, t, n);
                                    }
                                }),
                                [2, l]
                            );
        ...
        function _(e, t, n) {
            n.log(p.LogLevel.Error, t), e && e.stop();
        }
        (window.Blazor.start = E), l.shouldAutoStart() && E();
    },
    function (e, t, n) {
        "use strict";
                ...
                for (
                    ...
                    isNaN(t) || t === 1 / 0
                        ...
                        : ((a = Math.floor(Math.log(t) / Math.LN2)),
                            ...
                            (t += a + f >= 1 ? h / c : h * Math.pow(2, 1 - f)) * c >= 2 &&
                            (a++, (c /= 2)),
                            a + f >= l
                                ? ((s = 0), (a = l))
                                : a + f >= 1
        ...
        (e.exports = (function () {
            ...
            return (
                ...
                (e.prototype.concat = function (e) {
                    ...
                    for (
                        var t, n, o, i = r.allocUnsafe(e >>> 0), a = this.head, s = 0;
                        a;
...
function(e, t, n) {
    ...
    function s(e) {
        ...
        a.call(this, e), (this._wrap = "wrap" in e && e.wrap);
    }
    function c(e) {
    ...
    o(a, r),
        ...
        (c.prototype._transform = function (e, t, n) {
            ...
            try {
                ...
                this._wrap && (r = { value: r }), this.push(r);
            } catch (e) {
                return void (e instanceof this._msgpack.IncompleteBufferError
                    ? n()
                    : this.emit("error", e));
            }
        ...
        (e.exports = function (e) {
            ...
            function i(e, r) {
                ...
                switch (h) {
                    ...
                    case 217:
                        return t((i = e.readUInt8(r + 1)), o, 2)
                            ? n((p = e.toString("utf8", r + 2, r + 2 + i)), 2 + i)
                            : null;
                    case 218:
                        return t((i = e.readUInt16BE(r + 1)), o, 3)
                            ? n((p = e.toString("utf8", r + 3, r + 3 + i)), 3 + i)
                            : null;
                    case 219:
                        return t((i = e.readUInt32BE(r + 1)), o, 5)
                            ? n((p = e.toString("utf8", r + 5, r + 5 + i)), 5 + i)
                            : null;
                    case 196:
                        return t((i = e.readUInt8(r + 1)), o, 2)
                            ? n((p = e.slice(r + 2, r + 2 + i)), 2 + i)
                            : null;
                    case 197:
                        return t((i = e.readUInt16BE(r + 1)), o, 3)
                            ? n((p = e.slice(r + 3, r + 3 + i)), 3 + i)
                            : null;
                    case 198:
                        return t((i = e.readUInt32BE(r + 1)), o, 5)
                            ? n((p = e.slice(r + 5, r + 5 + i)), 5 + i)
                            : null;
                    case 220:
                        return o < 3
                            ? null
                            : ((i = e.readUInt16BE(r + 1)), a(e, r, i, 3));
                    case 221:
                        return o < 5
                            ? null
                            : ((i = e.readUInt32BE(r + 1)), a(e, r, i, 5));
                    case 222:
                        return (i = e.readUInt16BE(r + 1)), s(e, r, i, 3);
                    case 223:
                        return (i = e.readUInt32BE(r + 1)), s(e, r, i, 5);
                    case 212:
                        return c(e, r, 1);
                    case 213:
                        return c(e, r, 2);
                    ...
                    case 199:
                        return (
                            (i = e.readUInt8(r + 1)),
                            (l = e.readUInt8(r + 2)),
                            t(i, o, 3) ? u(e, r, l, i, 3) : null
                        );
                    case 200:
                        return (
                            (i = e.readUInt16BE(r + 1)),
                            (l = e.readUInt8(r + 3)),
                            t(i, o, 4) ? u(e, r, l, i, 4) : null
                        );
                    case 201:
                        return (
                            (i = e.readUInt32BE(r + 1)),
                            (l = e.readUInt8(r + 5)),
                            t(i, o, 6) ? u(e, r, l, i, 6) : null
                        );
                }
                ...
                if (160 == (224 & h))
                    return t((i = 31 & h), o, 1)
                        ? n((p = e.toString("utf8", r + 1, r + i + 1)), i + 1)
                        : null;
            ...
            function s(e, t, r, o) {
                ...
                for (t += o, a = 0; a < r; a++) {
                    ...
                    (s[u.value] = l.value),
                        (t += l.bytesConsumed),
                        (c += u.bytesConsumed + l.bytesConsumed);
                }
                return n(s, o + c);
            }
            function c(e, t, n) {
            ...
            function u(t, r, o, i, a) {
                ...
                for (s = 0; s < e.length; s++) {
                    if (o === e[s].type)
                        return (c = t.slice(r, r + i)), n(e[s].decode(c), a + i);
                }
...
function(e, t, n) {
    ...
    function i(e, t) {
        var n,
            o = !0;
        return (
            Math.fround && (o = Math.fround(e) !== e),
            t && (o = !0),
            o
                ? (((n = r.allocUnsafe(9))[0] = 203), n.writeDoubleBE(e, 1))
                : (((n = r.allocUnsafe(5))[0] = 202), n.writeFloatBE(e, 1)),
            n
        );
    }
    e.exports = function (e, t, n, a) {
        function s(c, u) {
            ...
            if ((h = c) != h && "number" == typeof h)
                throw new Error("NaN is not encodable in msgpack!");
            if (null === c) (l = r.allocUnsafe(1))[0] = 192;
            else if (!0 === c) (l = r.allocUnsafe(1))[0] = 195;
            else if (!1 === c) (l = r.allocUnsafe(1))[0] = 194;
            else if ("string" == typeof c)
                (f = r.byteLength(c)) < 32
                    ? (((l = r.allocUnsafe(1 + f))[0] = 160 | f),
                        f > 0 && l.write(c, 1))
                    : f <= 255 && !n
                        ? (((l = r.allocUnsafe(2 + f))[0] = 217), (l[1] = f), l.write(c, 2))
                        : f <= 65535
                            ? (((l = r.allocUnsafe(3 + f))[0] = 218),
                                l.writeUInt16BE(f, 1),
                                l.write(c, 3))
                            : (((l = r.allocUnsafe(5 + f))[0] = 219),
                                l.writeUInt32BE(f, 1),
                                l.write(c, 5));
            else if (c && (c.readUInt32LE || c instanceof Uint8Array))
                c instanceof Uint8Array && (c = r.from(c)),
                    c.length <= 255
                        ? (((l = r.allocUnsafe(2))[0] = 196), (l[1] = c.length))
                        : c.length <= 65535
                            ? (((l = r.allocUnsafe(3))[0] = 197),
                                l.writeUInt16BE(c.length, 1))
                            : (((l = r.allocUnsafe(5))[0] = 198),
                                l.writeUInt32BE(c.length, 1)),
                    (l = o([l, c]));
            else if (Array.isArray(c))
                c.length < 16
                    ? ((l = r.allocUnsafe(1))[0] = 144 | c.length)
                    : c.length < 65536
                        ? (((l = r.allocUnsafe(3))[0] = 220), l.writeUInt16BE(c.length, 1))
                        : (((l = r.allocUnsafe(5))[0] = 221), l.writeUInt32BE(c.length, 1)),
                    (l = c.reduce(function (e, t) {
                        return e.append(s(t, !0)), e;
                    }, o().append(l)));
            else {
                if (!a && "function" == typeof c.getDate)
                    return (function (e) {
                        var t,
                            n = 1 * e,
                            i = Math.floor(n / 1e3),
                            a = 1e6 * (n - 1e3 * i);
                        if (a || i > 4294967295) {
                            ((t = r.allocUnsafe(10))[0] = 215), (t[1] = -1);
                            var s = 4 * a,
                                c = i / Math.pow(2, 32),
                                u = (s + c) & 4294967295,
                                l = 4294967295 & i;
                ...
                if ("object" == typeof c)
                        ...
                        (function (e) {
                            ...
                            for (t in e)
                                e.hasOwnProperty(t) &&
                                    void 0 !== e[t] &&
                                    "function" != typeof e[t] &&
                                    (++a, i.push(s(t, !0)), i.push(s(e[t], !0)));
                            a < 16
                                ? ((n = r.allocUnsafe(1))[0] = 128 | a)
                                : a < 65535
                                    ? (((n = r.allocUnsafe(3))[0] = 222), n.writeUInt16BE(a, 1))
                                    : (((n = r.allocUnsafe(5))[0] = 223), n.writeUInt32BE(a, 1));
                            return (
                                i.unshift(n),
                    ...
                    if (
                        ...
                        return i(c, t);
                    if (c >= 0)
                        if (c < 128) (l = r.allocUnsafe(1))[0] = c;
                        else if (c < 256) ((l = r.allocUnsafe(2))[0] = 204), (l[1] = c);
                        else if (c < 65536)
                            ((l = r.allocUnsafe(3))[0] = 205), l.writeUInt16BE(c, 1);
                        else if (c <= 4294967295)
                            ((l = r.allocUnsafe(5))[0] = 206), l.writeUInt32BE(c, 1);
                        else {
                    ...
                    else if (c >= -32) (l = r.allocUnsafe(1))[0] = 256 + c;
                    else if (c >= -128)
                        ((l = r.allocUnsafe(2))[0] = 208), l.writeInt8(c, 1);
                    else if (c >= -32768)
                        ((l = r.allocUnsafe(3))[0] = 209), l.writeInt16BE(c, 1);
                    else if (c > -214748365)
                        ((l = r.allocUnsafe(5))[0] = 210), l.writeInt32BE(c, 1);
                    else {
                        if (!(c >= -9007199254740991)) return i(c, !0);
                        ((l = r.allocUnsafe(9))[0] = 211),
                            (function (e, t, n) {
                                ...
                                var o = n % 4294967296,
                                    i = n / 4294967296;
                                if (
                                    (e.writeUInt32BE(Math.floor(i), t + 0),
                ...
                (e.prototype.processBatch = function (e, t, n) {
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    return e < this.nextBatchId
                                        ? [4, this.completeBatch(n, e)]
                                        : [3, 2];
                                case 1:
                                    return (
                                        o.sent(),
                                        this.logger.log(
                                            ...
                                            "Batch " +
                                            e +
                                            " already processed. Waiting for batch " +
                                            this.nextBatchId +
                                            "."
                                        ),
                                        [2]
                                ...
                                case 2:
                                    return e > this.nextBatchId
                                        ? this.fatalError
                                            ? (this.logger.log(
                                                s.LogLevel.Debug,
                                                "Received a new batch " +
                                                e +
                                                " but errored out on a previous batch " +
                                                (this.nextBatchId - 1)
                                            ),
                                                [
                                                    4,
                                ...
                                case 5:
                                    return (
                                        ...
                                        i.renderBatch(
                                            ...
                                            new a.OutOfProcessRenderBatch(t)
                                        ),
                                        [4, this.completeBatch(n, e)]
                                    );
                                case 6:
                                ...
                                case 7:
                                    throw ((r = o.sent()),
                                        (this.fatalError = r.toString()),
                                        this.logger.log(
                                            s.LogLevel.Error,
                                            "There was an error applying batch " + e + "."
                                        ),
                                        n.send("OnRenderCompleted", e, r.toString()),
                                        r);
                                case 8:
                                    return [2];
                            }
                            ...
                            switch (n.label) {
                                ...
                                case 2:
                                    return (
                                        ...
                                        this.logger.log(
                                            s.LogLevel.Warning,
                                            "Failed to deliver completion notification for render '" +
                                            t +
                                            "'."
                                        ),
                                        [3, 3]
...
function(e, t, n) {
    ...
    var r = n(37),
        ...
        i = (function () {
            function e(e) {
                this.batchData = e;
                var t = new u(e);
                (this.arrayRangeReader = new l(e)),
                    (this.arrayBuilderSegmentReader = new f(e)),
                    (this.diffReader = new a(e)),
                    (this.editReader = new s(e, t)),
                    (this.frameReader = new c(e, t));
            }
            return (
    ...
    var a = (function () {
        ...
        s = (function () {
            ...
            return (
                (e.prototype.editType = function (e) {
                    return o.readInt32LE(this.batchDataUint8, e);
                }),
        ...
        c = (function () {
            ...
            return (
                (e.prototype.frameType = function (e) {
                    return o.readInt32LE(this.batchDataUint8, e);
                }),
        ...
        u = (function () {
            function e(e) {
                (this.batchDataUint8 = e),
                    (this.stringTableStartIndex = o.readInt32LE(e, e.length - 4));
            }
            return (
...
function(e, t, n) {
        ...
        s = (function () {
            ...
            return (
                            ...
                            switch (n.label) {
                                case 0:
                                    return [
                                        ...
                                        e.invoke(
                                            "StartCircuit",
                                            i.internalFunctions.getBaseURI(),
                                            i.internalFunctions.getLocationHref(),
                                            JSON.stringify(
                ...
                (e.prototype.resolveElement = function (e) {
                    ...
                    if (Number.isNaN(t))
                        throw new Error("Invalid sequence number '" + e + "'.");
                    return a.toLogicalRootCommentElement(
                        this.components[t].start,
                        this.components[t].end
                    );
                }),
                e
            );
    ...
    (t.ComponentDescriptor = c),
        (t.discoverComponents = function (e) {
            for (
                var t = (function e(t) {
                    if (!t.hasChildNodes()) return [];
                    var n = [],
                        r = new h(t.childNodes);
                    for (; r.next() && r.currentElement;) {
                        var o = l(r);
                        if (o) n.push(o);
                        else
                            for (var i = e(r.currentElement), a = 0; a < i.length; a++) {
                                var s = i[a];
                                n.push(s);
                            }
                    }
                ...
                var o = t[r],
                    i = new c(o.type, o.start, o.end, o.sequence, o.descriptor);
                n.push(i);
            }
    ...
    function l(e) {
        ...
        if (t && t.nodeType === Node.COMMENT_NODE && t.textContent) {
            var n = new RegExp(u).exec(t.textContent),
                r = n && n[1];
            if (!r) return;
            try {
                return (function (e, t, n) {
                    var r = JSON.parse(e),
                        ...
                        s = r.prerenderId;
                    if ("server" !== o)
                        throw new Error("Invalid component type '" + o + "'.");
                    if (!a)
                        throw new Error(
                        ...
                        var c = (function (e, t) {
                            for (; t.next() && t.currentElement;) {
                                ...
                                if (n.nodeType === Node.COMMENT_NODE && n.textContent) {
                                    var r = new RegExp(u).exec(n.textContent),
                                        o = r && r[1];
                                    if (o) return f(o, e), n;
                                }
                            }
                    ...
                    return { type: o, sequence: i, descriptor: a, start: t };
                })(r, t, e);
            } catch (e) {
                throw new Error(
                    "Found malformed component comment at " + t.textContent
                );
            }
        }
    }
...
function(e, t, n) {
    ...
    t.resolveOptions = function (e) {
        ...
        return (
            e &&
            e.reconnectionOptions &&
            (t.reconnectionOptions = r(
                r({}, i.reconnectionOptions),
                e.reconnectionOptions
            )),
            t
        );
...
function(e, t, n) {
    ...
    var i = n(93),
        ...
        c = (function () {
            ...
            return (
                (e.prototype.onConnectionDown = function (e, t) {
                    if (!this._reconnectionDisplay) {
                        var n = document.getElementById(e.dialogId);
                        this._reconnectionDisplay = n
                            ? new a.UserSpecifiedDisplay(n)
                            : new i.DefaultReconnectDisplay(
                                e.dialogId,
                                document,
                                this._logger
                            );
                    ...
                    this._currentReconnectionProcess ||
                        (this._currentReconnectionProcess = new u(
                            e,
                            this._logger,
                            this._reconnectCallback,
    ...
    var u = (function () {
        ...
        return (
            ...
            (e.prototype.attemptPeriodicReconnection = function (e) {
                return r(this, void 0, void 0, function () {
                    var t, n;
                    return o(this, function (r) {
                        switch (r.label) {
                            case 0:
                                (t = 0), (r.label = 1);
                            case 1:
                                return t < e.maxRetries
                                    ? [4, this.delay(e.retryIntervalMilliseconds)]
                                    : [3, 7];
                            case 2:
                                if ((r.sent(), this.isDisposed)) return [3, 7];
                                r.label = 3;
                            case 3:
                                return (
                                    r.trys.push([3, 5, , 6]), [4, this.reconnectCallback()]
                                );
                            case 4:
                                return r.sent() || this.reconnectDisplay.rejected(), [2];
                            case 5:
                                return (
                                    (n = r.sent()), this.logger.log(s.LogLevel.Error, n), [3, 6]
                                );
                            case 6:
                                return t++, [3, 1];
                            case 7:
            ...
            function e(e, t, n) {
                ...
                (this.modal.style.cssText = [
                    ...
                    (this.modal.innerHTML =
                        '<h5 style="margin-top: 20px"></h5><button style="margin:5px auto 5px">Retry</button><p>Alternatively, <a href>reload</a></p>'),
                        ...
                        return r(a, void 0, void 0, function () {
                            ...
                            return o(this, function (t) {
                                switch (t.label) {
                                    ...
                                    case 1:
                                        return (
                                            t.trys.push([1, 3, , 4]), [4, window.Blazor.reconnect()]
                                        );
                                    case 2:
                                    ...
                                    case 3:
                                        return (
                                            (e = t.sent()),
                                            this.logger.log(i.LogLevel.Error, e),
                                            this.failed(),
                                            [3, 4]
                                        );
                                    case 4:
            ...
            return (
                ...
                (e.prototype.failed = function () {
                    (this.button.style.display = "block"),
                        ...
                        (this.message.innerHTML =
                            "Reconnection failed. Try <a href>reloading</a> the page if you're unable to reconnect."),
                        this.message
                            .querySelector("a")
                            .addEventListener("click", function () {
                                return location.reload();
                ...
                (e.prototype.rejected = function () {
                    (this.button.style.display = "none"),
                        (this.reloadParagraph.style.display = "none"),
                        (this.message.innerHTML =
                            "Could not reconnect to the server. <a href>Reload</a> the page to restore functionality."),
                        this.message
                            .querySelector("a")
                            .addEventListener("click", function () {
                                return location.reload();
...
function(e, t, n) {
    ...
    var r = (function () {
        ...
        return (
            ...
            (e.RejectedClassName = "components-reconnect-rejected"),
            e
        );
    })();
    ...
    var r = n(8),
        ...
        a = (function () {
            ...
            return (
                ...
                (e.parse = function (e) {
                    for (
                        var t = [], n = new Uint8Array(e), r = [0, 7, 14, 21, 28], o = 0;
                        o < e.byteLength;
            ...
            return (
                (e.prototype.parseMessages = function (e, t) {
                    if (
                        ...
                        throw new Error(
                            "Invalid input for MessagePack hub protocol. Expected an ArrayBuffer or Buffer."
                        );
                    var n;
                        ...
                        default:
                            return (
                                t.log(
                                    ...
                                    "Unknown message type '" + a + "' ignored."
                                ),
                                null
                            );
                    }
                ...
                (e.prototype.createPingMessage = function (e) {
                    ...
                    return { type: i.MessageType.Ping };
                }),
                ...
                (e.prototype.createCompletionMessage = function (e, t) {
                    ...
                    var n,
                        r,
                        o = t[3];
                    if (o !== this.voidResult && t.length < 5)
                        throw new Error("Invalid payload for Completion message.");
                    switch (o) {
                ...
                (e.prototype.writeStreamInvocation = function (e) {
                    var t = o().encode([
                        i.MessageType.StreamInvocation,
                        e.headers || {},
                        e.invocationId,
                        e.target,
                        e.arguments,
